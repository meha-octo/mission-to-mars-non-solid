...
public class HelicoptereTests
{
    ...
    [Test]
    public void DoitAvancer1CaseVersNordEt1CaseVersOuesSiTourneVersNordOuest()
    {
        // Arrange
        sut = new Helicoptere(Direction.Nord_Ouest, new Position(4, 4, 1));

        // Act
        sut.Avancer();

        // Assert
        sut.Position.ShouldBe(new Position(3, 5, 1));
    }
    ...
    [Test]
    public void DoitReculer1CaseVersNordEt1CaseVersOuesSiTourneVersNordOuest()
    {
        // Arrange
        sut = new Helicoptere(Direction.Nord_Ouest, new Position(4, 4, 1));
        ...
        // Assert
        sut.Position.ShouldBe(new Position(5, 3, 1));
    }
